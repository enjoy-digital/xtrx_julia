//--------------------------------------------------------------------------------
// Auto-generated by LiteX (3959ca39) on 2022-08-16 16:39:08
//--------------------------------------------------------------------------------
...
/* leds2 */
#define CSR_LEDS2_BASE (CSR_BASE + 0x4800L)
#define CSR_LEDS2_OUT_ADDR (CSR_BASE + 0x4800L)
...
#define CSR_PCIE_DMA0_WRITER_TABLE_VALUE_SIZE 3
#define CSR_PCIE_DMA0_WRITER_TABLE_VALUE_ADDRESS_OFFSET 0
#define CSR_PCIE_DMA0_WRITER_TABLE_VALUE_ADDRESS_SIZE 64
#define CSR_PCIE_DMA0_WRITER_TABLE_VALUE_LENGTH_OFFSET 64
#define CSR_PCIE_DMA0_WRITER_TABLE_VALUE_LENGTH_SIZE 24
#define CSR_PCIE_DMA0_WRITER_TABLE_VALUE_IRQ_DISABLE_OFFSET 88
#define CSR_PCIE_DMA0_WRITER_TABLE_VALUE_IRQ_DISABLE_SIZE 1
#define CSR_PCIE_DMA0_WRITER_TABLE_VALUE_LAST_DISABLE_OFFSET 89
#define CSR_PCIE_DMA0_WRITER_TABLE_VALUE_LAST_DISABLE_SIZE 1
#define CSR_PCIE_DMA0_WRITER_TABLE_WE_ADDR (CSR_BASE + 0x6010L)
#define CSR_PCIE_DMA0_WRITER_TABLE_WE_SIZE 1
#define CSR_PCIE_DMA0_WRITER_TABLE_LOOP_PROG_N_ADDR (CSR_BASE + 0x6014L)
#define CSR_PCIE_DMA0_WRITER_TABLE_LOOP_PROG_N_SIZE 1
#define CSR_PCIE_DMA0_WRITER_TABLE_LOOP_STATUS_ADDR (CSR_BASE + 0x6018L)
...
#define CSR_PCIE_DMA0_WRITER_TABLE_LEVEL_ADDR (CSR_BASE + 0x601cL)
#define CSR_PCIE_DMA0_WRITER_TABLE_LEVEL_SIZE 1
#define CSR_PCIE_DMA0_WRITER_TABLE_RESET_ADDR (CSR_BASE + 0x6020L)
#define CSR_PCIE_DMA0_WRITER_TABLE_RESET_SIZE 1
#define CSR_PCIE_DMA0_READER_ENABLE_ADDR (CSR_BASE + 0x6024L)
#define CSR_PCIE_DMA0_READER_ENABLE_SIZE 1
#define CSR_PCIE_DMA0_READER_TABLE_VALUE_ADDR (CSR_BASE + 0x6028L)
#define CSR_PCIE_DMA0_READER_TABLE_VALUE_SIZE 3
#define CSR_PCIE_DMA0_READER_TABLE_VALUE_ADDRESS_OFFSET 0
#define CSR_PCIE_DMA0_READER_TABLE_VALUE_ADDRESS_SIZE 64
#define CSR_PCIE_DMA0_READER_TABLE_VALUE_LENGTH_OFFSET 64
#define CSR_PCIE_DMA0_READER_TABLE_VALUE_LENGTH_SIZE 24
#define CSR_PCIE_DMA0_READER_TABLE_VALUE_IRQ_DISABLE_OFFSET 88
#define CSR_PCIE_DMA0_READER_TABLE_VALUE_IRQ_DISABLE_SIZE 1
#define CSR_PCIE_DMA0_READER_TABLE_VALUE_LAST_DISABLE_OFFSET 89
#define CSR_PCIE_DMA0_READER_TABLE_VALUE_LAST_DISABLE_SIZE 1
#define CSR_PCIE_DMA0_READER_TABLE_WE_ADDR (CSR_BASE + 0x6034L)
#define CSR_PCIE_DMA0_READER_TABLE_WE_SIZE 1
#define CSR_PCIE_DMA0_READER_TABLE_LOOP_PROG_N_ADDR (CSR_BASE + 0x6038L)
#define CSR_PCIE_DMA0_READER_TABLE_LOOP_PROG_N_SIZE 1
#define CSR_PCIE_DMA0_READER_TABLE_LOOP_STATUS_ADDR (CSR_BASE + 0x603cL)
...
#define CSR_PCIE_DMA0_READER_TABLE_LEVEL_ADDR (CSR_BASE + 0x6040L)
#define CSR_PCIE_DMA0_READER_TABLE_LEVEL_SIZE 1
#define CSR_PCIE_DMA0_READER_TABLE_RESET_ADDR (CSR_BASE + 0x6044L)
#define CSR_PCIE_DMA0_READER_TABLE_RESET_SIZE 1
#define CSR_PCIE_DMA0_LOOPBACK_ENABLE_ADDR (CSR_BASE + 0x6048L)
...
#define CSR_PCIE_DMA0_BUFFERING_READER_FIFO_CONTROL_DEPTH_SIZE 15
...
#define CSR_PCIE_DMA0_BUFFERING_READER_FIFO_STATUS_LEVEL_SIZE 15
...
#define CSR_PCIE_DMA0_BUFFERING_WRITER_FIFO_CONTROL_DEPTH_SIZE 15
...
#define CSR_PCIE_DMA0_BUFFERING_WRITER_FIFO_STATUS_LEVEL_SIZE 15
...
/* gpio */
#define CSR_GPIO_BASE (CSR_BASE + 0xb000L)
#define CSR_GPIO_CONTROL_ADDR (CSR_BASE + 0xb000L)
#define CSR_GPIO_CONTROL_SIZE 1
#define CSR_GPIO_CONTROL_GPIO0_OFFSET 0
#define CSR_GPIO_CONTROL_GPIO0_SIZE 1
#define CSR_GPIO_CONTROL_GPIO1_OFFSET 1
#define CSR_GPIO_CONTROL_GPIO1_SIZE 1
#define CSR_GPIO_CONTROL_GPIO2_OFFSET 2
#define CSR_GPIO_CONTROL_GPIO2_SIZE 1
#define CSR_GPIO_CONTROL_GPIO3_OFFSET 3
#define CSR_GPIO_CONTROL_GPIO3_SIZE 1
#define CSR_GPIO_CONTROL_GPIO4_OFFSET 4
#define CSR_GPIO_CONTROL_GPIO4_SIZE 1
#define CSR_GPIO_CONTROL_GPIO5_OFFSET 5
#define CSR_GPIO_CONTROL_GPIO5_SIZE 1
#define CSR_GPIO_CONTROL_GPIO6_OFFSET 6
#define CSR_GPIO_CONTROL_GPIO6_SIZE 1
