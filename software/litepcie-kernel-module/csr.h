//--------------------------------------------------------------------------------
// Auto-generated by LiteX (e12af4f0) on 2022-09-20 12:16:56
//--------------------------------------------------------------------------------
...
/* spi */
#define CSR_SPI_BASE (CSR_BASE + 0xd800L)
#define CSR_SPI_W_ADDR (CSR_BASE + 0xd800L)
#define CSR_SPI_W_SIZE 1
#define CSR_SPI_W_CLK_OFFSET 0
#define CSR_SPI_W_CLK_SIZE 1
#define CSR_SPI_W_MOSI_OFFSET 1
#define CSR_SPI_W_MOSI_SIZE 1
#define CSR_SPI_W_OE_OFFSET 2
#define CSR_SPI_W_OE_SIZE 1
#define CSR_SPI_W_CS_OFFSET 4
#define CSR_SPI_W_CS_SIZE 1
#define CSR_SPI_R_ADDR (CSR_BASE + 0xd804L)
#define CSR_SPI_R_SIZE 1
#define CSR_SPI_R_MISO_OFFSET 0
#define CSR_SPI_R_MISO_SIZE 1
#define CSR_SPI_R_MOSI_OFFSET 1
#define CSR_SPI_R_MOSI_SIZE 1
