...
const CSR_PCIE_DMA0_SYNCHRONIZER_BYPASS_ADDR = CSR_BASE + Clong(0x6044)

const CSR_PCIE_DMA0_SYNCHRONIZER_BYPASS_SIZE = 1

const CSR_PCIE_DMA0_SYNCHRONIZER_ENABLE_ADDR = CSR_BASE + Clong(0x6048)

const CSR_PCIE_DMA0_SYNCHRONIZER_ENABLE_SIZE = 1

const CSR_PCIE_DMA0_SYNCHRONIZER_ENABLE_MODE_OFFSET = 0

const CSR_PCIE_DMA0_SYNCHRONIZER_ENABLE_MODE_SIZE = 2

const CSR_PCIE_DMA0_BUFFERING_READER_FIFO_CONTROL_ADDR = CSR_BASE + Clong(0x604c)
...
const CSR_PCIE_DMA0_BUFFERING_READER_FIFO_STATUS_ADDR = CSR_BASE + Clong(0x6050)
...
const CSR_PCIE_DMA0_BUFFERING_WRITER_FIFO_CONTROL_ADDR = CSR_BASE + Clong(0x6054)
...
const CSR_PCIE_DMA0_BUFFERING_WRITER_FIFO_STATUS_ADDR = CSR_BASE + Clong(0x6058)
...
const CSR_XSYNC_SPI_BASE = CSR_BASE + Clong(0xd800)

const CSR_XSYNC_SPI_CONTROL_ADDR = CSR_BASE + Clong(0xd800)

const CSR_XSYNC_SPI_CONTROL_SIZE = 1

const CSR_XSYNC_SPI_CONTROL_START_OFFSET = 0

const CSR_XSYNC_SPI_CONTROL_START_SIZE = 1

const CSR_XSYNC_SPI_CONTROL_LENGTH_OFFSET = 8

const CSR_XSYNC_SPI_CONTROL_LENGTH_SIZE = 8

const CSR_XSYNC_SPI_STATUS_ADDR = CSR_BASE + Clong(0xd804)

const CSR_XSYNC_SPI_STATUS_SIZE = 1

const CSR_XSYNC_SPI_STATUS_DONE_OFFSET = 0

const CSR_XSYNC_SPI_STATUS_DONE_SIZE = 1

const CSR_XSYNC_SPI_MOSI_ADDR = CSR_BASE + Clong(0xd808)

const CSR_XSYNC_SPI_MOSI_SIZE = 1

const CSR_XSYNC_SPI_MISO_ADDR = CSR_BASE + Clong(0xd80c)

const CSR_XSYNC_SPI_MISO_SIZE = 1

const CSR_XSYNC_SPI_CS_ADDR = CSR_BASE + Clong(0xd810)

const CSR_XSYNC_SPI_CS_SIZE = 1

const CSR_XSYNC_SPI_CS_SEL_OFFSET = 0

const CSR_XSYNC_SPI_CS_SEL_SIZE = 1

const CSR_XSYNC_SPI_CS_MODE_OFFSET = 16

const CSR_XSYNC_SPI_CS_MODE_SIZE = 1

const CSR_XSYNC_SPI_LOOPBACK_ADDR = CSR_BASE + Clong(0xd814)

const CSR_XSYNC_SPI_LOOPBACK_SIZE = 1

const CSR_XSYNC_SPI_LOOPBACK_MODE_OFFSET = 0

const CSR_XSYNC_SPI_LOOPBACK_MODE_SIZE = 1

const CSR_SYNCHRO_BASE = CSR_BASE + Clong(0xe000)

const CSR_SYNCHRO_CONTROL_ADDR = CSR_BASE + Clong(0xe000)

const CSR_SYNCHRO_CONTROL_SIZE = 1

const CSR_SYNCHRO_CONTROL_INT_SOURCE_OFFSET = 0

const CSR_SYNCHRO_CONTROL_INT_SOURCE_SIZE = 4

const CSR_SYNCHRO_CONTROL_OUT_SOURCE_OFFSET = 4

const CSR_SYNCHRO_CONTROL_OUT_SOURCE_SIZE = 4
