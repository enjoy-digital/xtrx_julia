...
inline void SoapyXTRX::i2c0_oe_scl_sda(bool oe, bool scl, bool sda)
{
...
void SoapyXTRX::i2c0_start(void)
{
...
void SoapyXTRX::i2c0_transmit_bit(int value)
{
...
// Call when in the middle of SCL low, advances one clk period
int SoapyXTRX::i2c0_receive_bit(void)
{
	int value;
...
bool SoapyXTRX::i2c0_transmit_byte(unsigned char data)
{
	int i;
	int ack;
...
unsigned char SoapyXTRX::i2c0_receive_byte(bool ack)
{
	int i;
...
// Reset line state
void SoapyXTRX::i2c0_reset(void)
{
	int i;
	i2c0_oe_scl_sda(1, 1, 1);
	I2C0_DELAY(8);
 ...
 */
bool SoapyXTRX::i2c0_read(unsigned char slave_addr, unsigned char addr, unsigned char *data, unsigned int len, bool send_stop)
{
	int i;
 ...
 */
bool SoapyXTRX::i2c0_write(unsigned char slave_addr, unsigned char addr, const unsigned char *data, unsigned int len)
{
	int i;
...
bool SoapyXTRX::i2c0_poll(unsigned char slave_addr)
{
    bool result;
