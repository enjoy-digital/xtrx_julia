...
/* flash_cs_n */
#define CSR_FLASH_CS_N_BASE (CSR_BASE + 0x2800L)
#define CSR_FLASH_CS_N_OUT_ADDR (CSR_BASE + 0x2800L)
...
#define CSR_GPIO_CONTROL_IOVCC_SEL_OFFSET 0
#define CSR_GPIO_CONTROL_IOVCC_SEL_SIZE 1
#define CSR_GPIO_CONTROL_EN_SMSIGIO_OFFSET 1
#define CSR_GPIO_CONTROL_EN_SMSIGIO_SIZE 1
